...
de clorofila ``a'' fueron obtenidas por un fluorómetro.
...
independencia entre las muestras. Por ende abordaremos un modelo
marginal con un diseño de medidas repetidas en el \textbf{espacio},
donde la falta de independencia de los datos con una matriz de
covarianzas. Este es un modelo generalizado lineal, ya que la variable
respuesta tiene una distribución Poisson y se usan medidas repetidas
(GEE).
...
asumimos una autroregresiva de orden uno, debido a que las distancias
...
Para comenzar, se pasaron las latitudes y longitudes a distancias,
tomando un punto de cada fuente como referencia y renombramos los
frentes.
...
observando las medias y la cantidad de muestras en cada una.
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.0375}}
  ...
  >{\raggedleft\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1125}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1125}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1250}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1125}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 16\tabcolsep) * \real{0.1250}}@{}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/explorativos-1.pdf}}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/explorativos-2.pdf}}\end{minipage}%
\newline
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/explorativos-3.pdf}}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/explorativos-4.pdf}}\end{minipage}%
\newline
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/explorativos-5.pdf}}\end{minipage}%
%
\begin{minipage}{0.50\linewidth}
\pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/explorativos-6.pdf}}\end{minipage}%
...
realizó un gráfico de correlación para evaluar la misma, separando por
cada frente.
...
\pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/unnamed-chunk-6-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/unnamed-chunk-8-1.pdf}}
...
Poisson que corrijan la subdispersion ( la documentación dice la
existencia de quasiPoisson pero no se logró que funcione) por lo que se
...
a que la distribución Poisson con \$\textbackslash lambda\$ mayor a ocho
se aproxima a esta.
...
homocedasticidad es problemática al convertirlo en Normal. Sin embaro,
se encuentra que estimando una varianza para cada frente soluciona la
falta de homocedasticidad. Se utilizó la función var Ident para el
modelado de la varianza.

Asimismo se probaron var Power y var Exp pero los resultados no fueron
satisfactorios debido a que no corrigen la heterocedasticidad. Además,
el modelado de varianza por var Ident no presenta un aumento
significativo de cantidad de parámetros estimados en comparación a los
otros.

\section{VER de agregar var Power y var
Exp}\label{ver-de-agregar-var-power-y-var-exp}

\paragraph{Seleccion de modelos}\label{seleccion-de-modelos}

Dada la alta correlación entre las variables explicativas, se decide por
criterio de interés biológico seleccionar a la salinidad superficial y
el Tamaño inverso de partículas. Como estas dos presentan una
correlación entre ellas, no serán utilizados en el mismo modelo, sino
que se generaran dos distintos: uno explicará las variaciones de la
riqueza a partir del ambiente, mientras el otro lo hará a partir de las
...
ende se analizó la salinidad superficial y el gamma de forma
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/alternativo-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/alternativo-2.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/alternativo-3.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/alternativo-4.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/alternativo-5.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/alternativo-6.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/alternativo-7.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/alternativo-8.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/alternativo-9.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/alternativo-10.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/alternativo-11.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/alternativo-12.pdf}}
...
un Phi de covarianza muy bajo, cercano a cero. Sin embargo se decidió
dejar la matriz de covarianzas ya que presentan mejor AIC que los mismos
modelos sin considerarla.
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/unnamed-chunk-12-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{Tp_entregar_files/figure-pdf/unnamed-chunk-13-1.pdf}}
...
Se observó que existe una relación, tanto entre la salinidad como con el
tamaño de los organismos, con la riqueza de plancton de la misma.

Por un lado, se notó que el número de especies varía según el polinomio
...
Además, la cantidad de taxones disminuyó linealmente a menores tamaños
...
\pandocbounded{\includegraphics[keepaspectratio]{images/dharma.jpeg}}
